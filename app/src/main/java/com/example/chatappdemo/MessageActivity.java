...
public class MessageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent it=new Intent(MessageActivity.this, MainActivity.class ).setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                //Intent it=new Intent(MessageActivity.this, MainActivity.class );
        ...
        apiService = Client.getClient("https://fcm.googleapis.com/v1/").create(APIService.class);
    ...
    private void sendMessage(String sender, final String receiver, String message){
        ...
        // adauga utilizator la fragmentul de chat
